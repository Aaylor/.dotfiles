...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (powerline spotify pyvenv pytest pyenv-mode py-yapf pip-requirements hy-mode helm-spotify multi helm-pydoc cython-mode company-auctex company-anaconda auctex-latexmk auctex anaconda-mode pythonic f disaster company-c-headers cmake-mode clang-format window-numbering volatile-highlights vi-tilde-fringe persp-mode pcre2el paradox hydra spinner open-junk-file move-text lorem-ipsum linum-relative leuven-theme info+ indent-guide hungry-delete highlight-parentheses highlight-numbers parent-mode highlight-indentation helm-themes helm-swoop helm-mode-manager helm-make helm-ag google-translate golden-ratio flx-ido fancy-battery expand-region evil-tutor evil-search-highlight-persist evil-numbers evil-nerd-commenter evil-mc evil-matchit evil-lisp-state evil-indent-plus evil-iedit-state iedit evil-exchange evil-args evil-anzu anzu eval-sexp-fu highlight define-word clean-aindent-mode buffer-move bracketed-paste auto-highlight-symbol aggressive-indent adaptive-wrap ace-window ace-link ace-jump-helm-line avy xterm-color ws-butler which-key utop use-package tuareg spacemacs-theme spaceline smooth-scrolling smeargle smartparens shell-pop restart-emacs rainbow-delimiters quelpa popwin page-break-lines orgit ocp-indent neotree multi-term mmm-mode merlin markdown-toc magit-gitflow macrostep ido-vertical-mode hl-todo help-fns+ helm-projectile helm-gitignore helm-flx helm-descbinds helm-company helm-c-yasnippet gitconfig-mode gitattributes-mode git-timemachine git-messenger git-gutter-fringe git-gutter-fringe+ gh-md flycheck-pos-tip fill-column-indicator exec-path-from-shell evil-visualstar evil-surround evil-magit evil-escape eshell-prompt-extras esh-help elisp-slime-nav diff-hl company-statistics company-quickhelp column-enforce-mode bind-map auto-yasnippet auto-compile ac-ispell))))
(custom-set-faces
